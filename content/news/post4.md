+++
title = "2025年度10月10日 《鳴門教育大学》教育データ活用シンポジウム開催のお知らせ"
date = "2025-08-10"
tags = ["鳴門教育大学", "研修", "センター"]
...
近年、教育現場では多様な学習データが日々蓄積されており、その効果的な活用がますます注目を集めています。
本シンポジウムでは、教育データサイエンスの基礎や実践事例が紹介され、学校現場における活用の意義と必要性について分かりやすく解説されます。<br> 
皆さまのご参加をお待ちしております。
<p align="center">
  <img src="/img/poster.png" alt="教育データ活用シンポジウム ポスター" width="400">
</p>
...
- **場所**：  
  <div style="display: flex; align-items: center; flex-wrap: wrap;">
    ...
    <a href="https://www.google.com/maps/place/Kokuritsunarutokyoikudaigaku+Fuzoku+Junior+High+School/@34.084407,134.557113,17z/data=!3m1!4b1!4m6!3m5!1s0x35536d7900257c75:0xde4036e8cdcd5bad!8m2!3d34.084407!4d134.557113!16s%2Fg%2F121ysv9h?entry=ttu&g_ep=EgoyMDI1MDgxMi4wIKXMDSoASAFQAw%3D%3D" 
       ...
       style="background-color: #429645ff; color: white; padding: 6px 12px; border-radius: 4px; text-decoration: none; margin-left: 20px;">
       アクセスはこちら
    </a>
  </div>  
...
<div style="display: flex; align-items: center; flex-wrap: wrap; gap: 10px;">
    ...
    <a href="https://forms.office.com/r/TL0k3bL3W8" 
     target="_blank" 
     rel="noopener noreferrer"
     style="background-color: #429645ff; color: white; padding: 10px 20px; border-radius: 4px; text-decoration: none;margin-left: 20px;">
     申し込みフォームはこちら
  </a>
  </div>